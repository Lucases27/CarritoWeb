...
public class Validaciones {
	...
	/**
	 * Valida que una cadena de texto sea de entre 5 y 10 caracteres y no contenga caracteres que no sean alfanumericos.
	 * @param campo String a validar. Por ej: un usuario o contraseña.
	 * @return True si el campo tiene entre 5 y 10 caracteres y no contiene caracteres raros. False en caso contrario.
	 */
